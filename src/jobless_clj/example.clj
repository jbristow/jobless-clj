...
(cv 
 ...
 (employment 
  (entry 
   ...
   (bulletin "Created test automation in Java, bash")
   (bulletin "Mentored developers on code quality and testing")
   (bulletin "Developed restful web services in clojure")
