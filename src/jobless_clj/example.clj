...
(def jon-bristow-resume
  (cv
   ...
   (homepage "https://jondotcomdotorg.net")
   (employment
    (entry
     (title "Lead Developer for Ingestion")
     (company "Defensestorm")
     (homepage "https://defensestorm.com")
     (technologies "bash, Angular, Typescript, python, aws, Java, C#")
     (bulletin "Planned and developed new features in for the company's log event ingestion architecture and its Java services.")
     (bulletin "Created debian packages and python scripts for managing a log forwarding appliance.")
     (bulletin "Worked with Visual Studio and C# to add features to a windows event forwarding agent.")
     (bulletin "Provided preliminary security forensic analysis of compromised vms.")
     (bulletin "Helped improve SSDLC methodologies by adding automatic static code analysis.")
    ...
    (entry
     ...
     (bulletin "Contributed to open source clojure development. (httpskit)")
    ...
    (entry
     ...
     (bulletin "Created and maintained Struts/J2EE applications (https://www.marcoarealestate.com)")
   ...
   (open-source
    ...
    (entry (title "https-kit/https-kit")
           (homepage "https://github.com/https-kit/https-kit")
           (technologies "clojure")
   ...
   (other-exp
    ...
    (entry
     (title "StackOverflow")
     (homepage "https://stackoverflow.com/users/113332/jbristow")))))
